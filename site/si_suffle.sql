...
BEGIN
	...
	SELECT MAX(bid) into lastboard FROM site_boards;
	runningboard := lastboard+1;
	
	insert into site_boards values(runningboard,c(1),c(2),c(3),null,null,1,null,0);
	insert into server_boards@server61 values(runningboard,c(4),c(5),c(6),null,null,1,null,0);
...
select * from server_boards@server61;